...
# E-Bike Compare Scheduler Startup Script
...
# Print banner
echo "====================================================="
echo "  E-Bike Compare - Starting scheduler"
echo "====================================================="
...
# Run the scheduler (runs crawler immediately and schedules daily updates)
echo "====================================================="
echo "  Starting crawler scheduler"
echo "  Crawler will run immediately and then daily at midnight"
